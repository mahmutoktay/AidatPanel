...
class _Translations$features$auth$onboarding$tr implements Translations$features$auth$onboarding$en {
	...
	@override String get otpSendFailed => 'Tek kullanımlık şifre gönderilemedi. Lütfen tekrar deneyin.';
...
extension on TranslationsTr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'features.auth.onboarding.otpSendFailed' => 'Tek kullanımlık şifre gönderilemedi. Lütfen tekrar deneyin.',
