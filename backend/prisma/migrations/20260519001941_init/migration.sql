...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('DUE_REMINDER', 'DUE_PAID', 'TICKET_UPDATE', 'ANNOUNCEMENT', 'SYSTEM', 'DEKONT_RECEIVED', 'DEKONT_MATCHED', 'DEKONT_PAYMENT_APPLIED', 'DEKONT_NEEDS_REVIEW');

-- CreateEnum
CREATE TYPE "DekontStatus" AS ENUM ('RECEIVED', 'EXTRACTING', 'EXTRACT_FAILED', 'PARSED', 'PARSE_LOW_CONFIDENCE', 'MATCHING', 'MATCHED', 'MATCH_AMBIGUOUS', 'UNMATCHED', 'PAYMENT_APPLIED', 'PAYMENT_PARTIAL', 'REJECTED', 'RECIPIENT_MISMATCH', 'NEEDS_MANAGER_REVIEW');
