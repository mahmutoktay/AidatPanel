-- FAZ 8: Site yönetimi — Site, SiteExpense, Building.siteId
...
ALTER TABLE "Building" ADD COLUMN "blockLabel" TEXT;
ALTER TABLE "Building" ADD COLUMN "addressExtra" TEXT;

CREATE INDEX "Building_siteId_idx" ON "Building"("siteId");

ALTER TABLE "Building" ADD CONSTRAINT "Building_siteId_fkey"
...
CREATE INDEX "SiteExpense_siteId_targetYear_targetMonth_idx"
    ON "SiteExpense"("siteId", "targetYear", "targetMonth");

ALTER TABLE "SiteExpense" ADD CONSTRAINT "SiteExpense_siteId_fkey"
    FOREIGN KEY ("siteId") REFERENCES "Site"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- Carryforward: site gider payı desteği
...
CREATE UNIQUE INDEX "DueExpenseCarryforward_siteExpenseId_apartmentId_key"
    ON "DueExpenseCarryforward"("siteExpenseId", "apartmentId");

ALTER TABLE "DueExpenseCarryforward" ADD CONSTRAINT "DueExpenseCarryforward_siteExpenseId_fkey"
    FOREIGN KEY ("siteExpenseId") REFERENCES "SiteExpense"("id") ON DELETE CASCADE ON UPDATE CASCADE;
